...
public class PostControllerTest {
    ...
    public void getPostByIdTest() throws Exception {
        //arrange
        Post post = new Post("1a2b", "Description", "3abc", "4abc");
        post.setId("1a2b");
    ...
    public void getAllPostsTest() throws Exception {
        //arrange
        Post post1 = new Post("1abc", "Description", "3abc", "4abc");
        Post post2 = new Post("2abc", "Description", "3abc", "4abc");
    ...
    public void addPostTest() throws Exception {
        //arrange
        Post post = new Post("1abc", "Description", "3abc", "4abc");
