...
public class CommentController {
    ...
    @GetMapping("/post/{id}")
    public ResponseEntity<List<Comment>> getCommentsByPostId(@PathVariable(value = "id") String postId){
        return new ResponseEntity<>(commentService.getCommentsByPostId(postId), OK);
